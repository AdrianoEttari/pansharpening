...
python train_diffusion_superres.py --epochs=1 --noise_schedule='cosine' --batch_size=128 --image_size=28 --lr=3e-4 --snapshot_name=snapshot.pt --model_name="$model_name" --noise_steps=2 --device='mps' --dataset_path='MNIST_data_superres' --inp_out_channels=1 --magnification_factor=4
