...
python Aggregation_Sampling.py --noise_schedule='cosine' --snapshot_name=snapshot.pt --noise_steps=1500 --model_input_size=256 --model_name="$model_name" --Degradation_type='DownBlur' --device='mps' --magnification_factor=2 --inp_out_channels=3 --patch_size=128 --stride=64 --img_lr_path='imgs_sample/aggregation_sampling_pics/up42_sample_250_lr.png' --destination_path='imgs_sample/aggregation_sampling_pics/up42_sample_250_sr.png' --UNet_type='Residual Attention UNet'
