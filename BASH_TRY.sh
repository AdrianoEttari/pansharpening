...
python train_UNet.py --epochs=1 --batch_size=2 --image_size=224 --lr=3e-4 --snapshot_name=snapshot.pt --model_name="$model_name" --device='mps' --dataset_path='anime_data_50k' --inp_out_channels=3 --loss=Perceptual --magnification_factor=4 --UNet_type='Attention UNet'
