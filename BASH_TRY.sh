...
python train_diffusion_superres_EMA.py --epochs=1 --noise_schedule='cosine' --batch_size=2 --image_size=224 --lr=5e-4 --snapshot_name=snapshot.pt --model_name="$model_name" --noise_steps=50 --device='mps' --dataset_path='anime_data_50k' --inp_out_channels=3 --loss=MSE --magnification_factor=4 --UNet_type='Residual Attention UNet'
