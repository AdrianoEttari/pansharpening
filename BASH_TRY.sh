...
# python train_diffusion_superres.py --epochs=1 --noise_schedule='cosine' --batch_size=128 --image_size=224 --lr=3e-4 --snapshot_name=snapshot.pt --model_name="$model_name" --noise_steps=1500 --device='cpu' --dataset_path='Human_Action_Recognition' --inp_out_channels=3 --loss=Huber --magnification_factor=4
